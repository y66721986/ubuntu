...
# Copyright (C) 2013-2015 Viljo Viitanen  and contributors
#
...
iptables -I FORWARD -s 192.168.200.0/24 -p tcp -m tcp --tcp-flags FIN,SYN,RST,ACK SYN -j TCPMSS --set-mss 1356
